class Whatsapp::ChannelCreationService
  ...
  def perform
    ...
    raise "Phone number #{@phone_info[:phone_number]} is already connected" if existing_channel
  ...
  def find_existing_channel
    Channel::Whatsapp.find_by(phone_number: @phone_info[:phone_number])
  end
