...
PERMISSIONS: Dict[Tuple[str, str], List[Role]] = {
    ...
    ("DELETE", "/messaging/*"): [Role.SUPERADMIN, Role.ADMIN],

    # METRICS
    ("GET", "/metrics/*"): [Role.SUPERADMIN, Role.ADMIN, Role.LOGISTICA, Role.VENTAS, Role.VIEWER],
    ("POST", "/metrics/*"): [Role.SUPERADMIN, Role.ADMIN],
}
