...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative bg-[#B8E6F5] md:bg-[url('/images/imagen-hero-desktop.avif')] bg-cover bg-center bg-no-repeat pt-32 sm:pt-40 md:pt-50 lg:pt-40 pb-8 sm:pb-12 md:pb-[54px]"
    >
      <div className="max-w-[90%] sm:max-w-[600px] md:max-w-[90%] mx-auto relative flex flex-col items-center md:flex-row md:items-start pt-4 sm:pt-6 md:pt-[27px] pb-4 sm:pb-6 md:pb-[27px] px-4 md:px-0">
        ...
        {/* Contenedor de Texto */}
        <div className="w-full md:w-[47.25%] relative z-[2] text-center md:text-left order-2 md:order-1 md:mt-[274.219px] md:mb-[274.219px] md:mr-[94.2969px]">
          <FadeUp delay={0}>
          ...
          <FadeUp delay={0.2}>
            <div className="relative animate-[0.2s_linear] break-words mb-8 sm:mb-12 md:mb-0">
              <div className="relative">
                <div className="flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-5 w-full max-w-[350px] md:max-w-full mx-auto md:mx-0">
                  <a
                    href="#contacto"
        ...
        {/* Imagen del Hero */}
        <div className="w-full md:w-[47.25%] relative z-[2] mt-6 sm:mt-8 md:mt-0 order-1 md:order-2 mb-6 md:mb-0">
          <FadeUp delay={0.3}>
