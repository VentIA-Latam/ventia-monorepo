 ...
 *
 * Esta página integra Chatwoot directamente en el panel de SuperAdmin de Ventia.
...
export default function SuperAdminChatwootPage() {
    ...
    const getChatwootUrl = () => {
        ...
        // Si hay un Account ID configurado, ir directo al dashboard de esa cuenta
        if (chatwootAccountId) {
            return `${chatwootBaseUrl}/app/accounts/${chatwootAccountId}/dashboard`;
        }

        // URL base del dashboard de Chatwoot
